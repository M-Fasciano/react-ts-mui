...
const SvgAddAPhoto = (props: SvgIconProps) => {
  const { ...other } = props;
  return (
    <SvgIcon
      width={24}
    ...
    >
      <path
        d="M3 8c0 .55.45 1 1 1s1-.45 1-1V6h2c.55 0 1-.45 1-1s-.45-1-1-1H5V2c0-.55-.45-1-1-1s-1 .45-1 1v2H1c-.55 0-1 .45-1 1s.45 1 1 1h2v2ZM13 17a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"
        fill="#000"
        fillOpacity={0.54}
      />
      <path
